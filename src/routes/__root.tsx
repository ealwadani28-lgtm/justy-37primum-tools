...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "أدوات ويب عربية مجانية وجاهزة للاستخدام: ذكاء اصطناعي، تسويق، تصميم، تحليلات، وأكثر." },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/justlator-logo.png" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://justlator.com/justlator-logo.png",
          description: "منصّة عربية تقدّم أدوات ويب مجانية تشمل الذكاء الاصطناعي، التسويق، التحليلات، والتصميم.",
          inLanguage: "ar",
        }),
      },
    ],
